"""
vani/training/rl_trainer.py

GRPO-based RL fine-tuning for Vani.
...
class GRPOTrainer:
    ...
    def __init__(
        self,
        model,                  # VaniModel (policy)
        ref_model,              # VaniModel (reference, frozen copy)
